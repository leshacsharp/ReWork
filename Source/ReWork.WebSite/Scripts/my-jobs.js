$(document).ready(function () {
    ...
    function FormatResult(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var html = "<tr><td class='col-ms-3'><input type='hidden' name='jobId' value='" + data[i].Id + "'/>" + 
            ...
            html += "<td class='col-md-2'><span class='date-added'>" +
                dateAdded + "</span></td><td class='col-md-2 text-center'><span class='price'>" +
                data[i].Price + "$</span></td><td class='col-md-4'>" +
